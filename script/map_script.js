...
const points = [
  { xPercent: 20, yPercent: 78, label: "Nexus", descriptionHtml: `
    ...
    <div class='two-image-grid'>
      <div class="image-container">
        <img src='images/map/Blue_Nexus.webp' alt='Image of Blue Nexus' class='point-image'>
        <div class="image-caption">Blue Nexus</div>
      </div>
      <div class="image-container">
        <img src='images/map/Red_Nexus.webp' alt='Image of Red Nexus' class='point-image'>
  ...
  { xPercent: 39, yPercent: 28, label: "Baron Nasher", descriptionHtml: `
    ...
    <div class='point-image'>
      <img src='images/map/Territorial_Baron_Nashor_Render.webp' alt='Image of Baron Nashor' class='point-image'>
  ...
  { xPercent: 48, yPercent: 24.5, label: "Red Brambleback", descriptionHtml: `
    ...
    <p>Spawns 1:30, respawns every 5:00.</p>
        <div class='two-image-grid'>
      <div class="image-container">
        <img src='images/map/Red_Brambleback_Render.webp' alt='Image of Red Brambleback' class='point-image'>
        <div class="image-caption">Red Brambleback</div>
      </div>
      <div class="image-container">
        <img src='images/map/Voidborn_Red_Brambleback_Render.webp' alt='Image of Voidborn Red Brambleback' class='point-image'>
  ...
  { xPercent: 33, yPercent: 40, label: "Blue Sentinel", descriptionHtml: `
    ...
    <div class='two-image-grid'>
      <div class="image-container">
        <img src='images/map/Blue_Sentinel_Render.webp' alt='Image of Blue Sentinel' class='point-image'>
        <div class="image-caption">Blue Sentinel</div>
      </div>
      <div class="image-container">
        <img src='images/map/Voidborn_Blue_Sentinel_Render.webp' alt='Image of Voidborn Blue Sentinel' class='point-image'>
  ...
  { xPercent: 61, yPercent: 60, label: "Dragon", descriptionHtml: `
    ...
    <div class="dragon-grid">
      <div class="dragon">
        <img src="images/map/Chemtech_Drake_spawn_symbol.webp" alt="Image of Chemtech Drake" class="dragon-icon">
        <span class="dragon-name">ChemTech Drake</span>
      </div>
      <div class="dragon">
        <img src="images/map/Cloud_Drake_spawn_symbol.webp" alt="Image of Cloud Drake" class="dragon-icon">
        <span class="dragon-name">Cloud Drake</span>
      </div>
      <div class="dragon">
        <img src="images/map/Hextech_Drake_spawn_symbol.webp" alt="Image of Hextech Drake" class="dragon-icon">
        <span class="dragon-name">Hextech Drake</span>
      </div>
      <div class="dragon">
        <img src="images/map/Infernal_Drake_spawn_symbol.webp" alt="Image of Infernal Drake" class="dragon-icon">
        <span class="dragon-name">Infernal Drake</span>
      </div>
      <div class="dragon">
        <img src="images/map/Mountain_Drake_spawn_symbol.webp" alt="Image of Mountain Drake" class="dragon-icon">
        <span class="dragon-name">Mountain Drake</span>
      </div>
      <div class="dragon">
        <img src="images/map/Ocean_Drake_spawn_symbol.webp" alt="Image of Ocean Drake" class="dragon-icon">
        <span class="dragon-name">Ocean Drake</span>
      </div>
      <div class="dragon">
        <img src="images/map/Elder_Drake_spawn_symbol.webp" alt="Image of Elder Drake" class="dragon-icon">
  ...
  { xPercent: 29.5, yPercent: 80, label: "Inhibitor", descriptionHtml: `
    ...
    <div class='two-image-grid'>
      <div class="image-container">
        <img src='images/map/Blue_Inhibitor.webp' alt='Image of Blue Inhibitor' class='point-image'>
        <div class="image-caption">Blue Inhibitor</div>
      </div>
      <div class="image-container">
        <img src='images/map/Red_Inhibitor.webp' alt='Image of Red Inhibitor' class='point-image'>
  ...
  { xPercent: 31.5, yPercent: 63, label: "Turret", descriptionHtml: `
      ...
      <div class='two-image-grid'>
      <div class="image-container">
        <img src='images/map/Chaos_Turret_Blue_Render.webp' alt='Image of Blue Turret' class='point-image'>
        <div class="image-caption">Blue Turret</div>
      </div>
      <div class="image-container">
        <img src='images/map/Chaos_Turret_Red_Render.webp' alt='Image of Red Turret' class='point-image'>
  ...
  { xPercent: 27, yPercent: 36, label: "Gromp", descriptionHtml: `
    ...
    <div class='point-image'>
      <img src='images/map/Gromp_Render.webp' alt='Image of Gromp' class='point-image'>
...
{ xPercent: 47, yPercent: 54, label: "Raptor Camp", descriptionHtml: `
  ...
  <div class='point-image'>
    <img src='images/map/Crimson_Raptor.webp' alt='Image of Crimson Raptor Camp' class='point-image'>
...
{ xPercent: 33, yPercent: 47, label: "Murk Wolf Camp", descriptionHtml: `
  ...
  <p>Spawns 1:30, respawns every 2:15.</p>
  <div class='point-image'>
    <img src='images/map/Murk_Wolf.webp' alt='Image of Murk Wolf Camp' class='point-image'>
...
{ xPercent: 54, yPercent: 70.5, label: "Krug Camp", descriptionHtml: `
  ...
  <p>Spawns 1:42, respawns every 2:15.</p>
  <div class='point-image'>
    <img src='images/map/Krug.webp' alt='Image of Krug Camp' class='point-image'>
...
{ xPercent: 37, yPercent: 33, label: "Rift Scuttler", descriptionHtml: `
  ...
  <p>Spawns 3:30, respawns every 2:30.</p>
      <div class='two-image-grid'>
      <div class="image-container">
        <img src='images/map/Rift_Scuttler_Render.webp' alt='Image of Rift Scuttler' class='point-image'>
        <div class="image-caption">Rift Scuttler</div>
      </div>
      <div class="image-container">
        <img src='images/map/Voidborn_Rift_Scuttler_Render.webp' alt='Image of Voidborn Rift Scuttler' class='point-image'>
...
const highlightFrames = {
  ...
  "Nexus": [
    { xPercent: 20, yPercent: 78, width: 4, height: 6, color: blue_color },
    { xPercent: 71, yPercent: 15, width: 4, height: 6, color: red_color },
  ],
  "Fountain": [
    { xPercent: 13, yPercent: 86, width: 4, height: 6, color: blue_color },
    { xPercent: 75, yPercent: 10, width: 4, height: 6, color: red_color },
  ],
  "Inhibitor": [
    { xPercent: 29.5, yPercent: 80, width: 4, height: 6, color: blue_color },
    { xPercent: 29, yPercent: 67, width: 4, height: 6, color: blue_color },
    { xPercent: 19, yPercent: 64, width: 4, height: 6, color: blue_color },
    { xPercent: 63, yPercent: 13, width: 4, height: 6, color: red_color },
    { xPercent: 65, yPercent: 21, width: 4, height: 6, color: red_color },
    { xPercent: 74, yPercent: 24, width: 4, height: 6, color: red_color },
  ],
  "Gromp": [
    { xPercent: 27, yPercent: 36, width: 4, height: 6, color: neutral_color },
    { xPercent: 72, yPercent: 48, width: 4, height: 6, color: neutral_color },
  ],

  "Murk Wolf Camp": [
    { xPercent: 33, yPercent: 47, width: 4, height: 6, color: neutral_color },
    { xPercent: 64, yPercent: 37, width: 4, height: 6, color: neutral_color },
  ],

  "Rift Scuttler": [
    { xPercent: 37, yPercent: 33, width: 4, height: 6, color: neutral_color },
    { xPercent: 61, yPercent: 54, width: 4, height: 6, color: neutral_color },
  ],

  "Red Brambleback": [
    { xPercent: 48, yPercent: 24.5, width: 4, height: 6, color: neutral_color },
    { xPercent: 51, yPercent: 61, width: 4, height: 6, color: neutral_color },
  ],

  "Blue Sentinel": [
    { xPercent: 33, yPercent: 40, width: 4, height: 6, color: neutral_color },
    { xPercent: 65, yPercent: 44, width: 4, height: 6, color: neutral_color },
  ],

  "Krug Camp": [
    { xPercent: 54, yPercent: 70.5, width: 4, height: 6, color: neutral_color },
    { xPercent: 45, yPercent: 19, width: 4, height: 6, color: neutral_color },
  ],
};
...
pointImage.src = "images/map/questionmark.png";
